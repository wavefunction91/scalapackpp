...
#include <scalapackpp/tradd.hpp>

SCALAPACKPP_TEST_CASE( "Tradd", "[tradd]" ) {
  ...
  ptradd( blacspp::Triangle::Lower, TransposeFlag::Transpose, N, M, fact, A_local.data(), 1, 1, desc_a,
