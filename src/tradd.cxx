...
void pstradd_( const char* UPLO, const char* TRANS, const scalapack_int* M, const scalapack_int* N, 
...
void pdtradd_( const char* UPLO, const char* TRANS, const scalapack_int* M, const scalapack_int* N, 
               const double* ALPHA, const double* A, const scalapack_int* IA, 
               const scalapack_int* JA, const scalapack_int* DESCA,
               const double* BETA, double* C, const scalapack_int* IC, 
               const scalapack_int* JC, const scalapack_int* DESCC );
void pctradd_( const char* UPLO, const char* TRANS, const scalapack_int* M, const scalapack_int* N, 
               const scomplex* ALPHA, const scomplex* A, const scalapack_int* IA, 
               const scalapack_int* JA, const scalapack_int* DESCA,
               const scomplex* BETA, scomplex* C, const scalapack_int* IC, 
               const scalapack_int* JC, const scalapack_int* DESCC );
void pztradd_( const char* UPLO, const char* TRANS, const scalapack_int* M, const scalapack_int* N, 
...
#define ptradd_impl(F,FNAME)                                              \
template <>                                                               \
void                                                                      \
  ptradd( const char* UPLO, const char* TRANS,                            \
...
ptradd_impl( float,    pstradd_ );
ptradd_impl( double,   pdtradd_ );
ptradd_impl( scomplex, pctradd_ );
ptradd_impl( dcomplex, pztradd_ );
