...
void pscopy_( const scalapack_int* N, const float* X, 
...
void pdcopy_( const scalapack_int* N, const double* X, 
              const scalapack_int* IX, const scalapack_int* JX, 
              const scalapack_int* DESCX, const scalapack_int* INCX,
              double* Y, const scalapack_int* IY, const scalapack_int* JY,
              const scalapack_int* DESCY, const scalapack_int* INCY );
void pccopy_( const scalapack_int* N, const scomplex* X, 
              const scalapack_int* IX, const scalapack_int* JX, 
              const scalapack_int* DESCX, const scalapack_int* INCX,
              scomplex* Y, const scalapack_int* IY, const scalapack_int* JY,
              const scalapack_int* DESCY, const scalapack_int* INCY );
void pzcopy_( const scalapack_int* N, const dcomplex* X, 
              const scalapack_int* IX, const scalapack_int* JX, 
              const scalapack_int* DESCX, const scalapack_int* INCX,
...
#define pcopy_impl(F,FNAME)\
template <>                                                              \
void pcopy( int64_t N,                                                   \
  ...
  auto _DESCY = detail::to_scalapack_int( DESCY );                       \
                                                                         \
  FNAME( &_N, X, &_IX, &_JX, _DESCX.data(), &_INCX,                      \
         Y, &_IY, &_JY, _DESCY.data(), &_INCY );                         \
                                                                         \
}


pcopy_impl( float,    pscopy_ );
pcopy_impl( double,   pdcopy_ );
pcopy_impl( scomplex, pccopy_ );
pcopy_impl( dcomplex, pzcopy_ );
}
}
