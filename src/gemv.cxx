 ...
 *  All rights reserved
 */
#include <scalapackpp/wrappers/pblas/gemv.hpp>
...
pgemv_impl( float,    psgemv_ );
pgemv_impl( double,   pdgemv_ );
pgemv_impl( scomplex, pcgemv_ );
pgemv_impl( dcomplex, pzgemv_ );
