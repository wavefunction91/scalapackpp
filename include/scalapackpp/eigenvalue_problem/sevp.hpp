...
detail::enable_if_scalapack_real_supported_t<T, int64_t>
  hereig( Job jobz, blacspp::Triangle uplo, int64_t N,
...
template <typename T>
detail::enable_if_scalapack_real_supported_t<T, int64_t>
  hereigd( Job jobz, blacspp::Triangle uplo, int64_t N,
           T* A, int64_t IA, int64_t JA, const scalapack_desc& DESCA,
           detail::real_t<T>* W,
           T* Z, int64_t IZ, int64_t JZ, const scalapack_desc& DESCZ ) {
...
detail::enable_if_scalapack_supported_t<T, int64_t>
  hereig( Job jobz, blacspp::Triangle uplo, 
...
template <typename T>
detail::enable_if_scalapack_supported_t<T, int64_t>
  hereigd( Job jobz, blacspp::Triangle uplo, 
           BlockCyclicMatrix<T>& A, detail::real_t<T>* W, BlockCyclicMatrix<T>& Z ) {
